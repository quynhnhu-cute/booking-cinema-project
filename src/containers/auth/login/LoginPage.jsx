...
class LoginPage extends Component {
  ...
  render() {
    ...
    >
        <h1 className="d-flex justify-content-center color-white pb-4">Đăng nhập</h1>
      ...
      <Form.Item className="d-flex justify-content-end">
        <Button type="default" htmlType="submit" className="login-form-button register-button">
          Đăng kí
        </Button>
